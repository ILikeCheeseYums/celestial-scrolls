...
function Section({
  ...
  return (
    <section
      id={planet.id}
      className="flex min-h-screen items-center px-6 py-24 md:px-16 snap-start snap-always"
  ...
  return (
    <>
      ...
      <main className="relative z-10">
        ...
        <section
          id={PLANETS[0]!.id}
          className="flex min-h-screen flex-col items-center justify-center px-6 text-center snap-start snap-always"
        >
